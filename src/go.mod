...
require (
	...
	github.com/HACKERALERT/infectious v0.0.0-20220103040724-97d3764a8217
	github.com/HACKERALERT/jibber_jabber v0.0.0-20211222174950-71570b6ee48b
...
require (
	github.com/AllenDang/giu v0.6.1 // indirect
